...
endpoint_url="http://localhost:3000/mark-item"
basic_header={'Content-Type': 'application/json'}
request_timeout=10
todo_user="unittest_returncode_markitem"
todo_item="buy apple"

def test_markitem_200():
    print("\n========================================== Test Cases: mark-item ==========================================")
